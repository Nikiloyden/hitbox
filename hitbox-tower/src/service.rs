...
use hitbox::{backend::CacheBackend, concurrency::BroadcastConcurrencyManager, fsm::CacheFuture};
    ...
    S::Error: Debug + Send,
{
    ...
    type Future = CacheServiceFuture<
        CacheFuture<
            ...
            BroadcastConcurrencyManager<Result<CacheableHttpResponse<ResBody>, S::Error>>,
        >,
        ResBody,
        S::Error,
    >;
